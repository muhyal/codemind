...
struct ChatSession: Identifiable, Codable, Equatable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, title, createdAt, entries, isFavorite, colorHex
    }

    // Initializer
    init(id: UUID = UUID(), title: String? = nil, createdAt: Date = Date(), entries: [ChatEntry] = [], isFavorite: Bool = false, colorHex: String? = nil) {
        self.id = id
    ...
    // Manual Decodable initializer to handle optional colorHex
